...
(function() {
  var DATA_FUNCD_ASYNC, Funcd, attributeList, defaultAttributes, doctypes, elements, escapeHtml, getTemplateFunction, htmlChars, idSequence, mergeElements, mixinShortTag, mixinTag, nextId, rawContentElements, replaceToken, requireEx, tokensToReplace, _, _slice,
    __slice = [].slice,
 ...
 nobr spacer tt',
  ...
  Funcd = (function() {
    ...
    Funcd.render = function(options, template) {
      var args, args1, builder, first;
      args = _slice.call(arguments);
      first = args[0];
      if (typeof first.main === "function") {
        template = first.main;
        options = {};
        args = args.slice(1);
        ...
        options = first;
        args1 = args[1];
        template = typeof args1 === "function" ? args1 : requireEx(args1, options.nocache);
        args = args.slice(2);
      }
  ...
  if (typeof jQuery !== "undefined" && jQuery !== null) {
    jQuery.fn.funcd = function(template, args) {
      return this.each(function() {
        var $obj;
        $obj = jQuery(this);
        return $obj.html(Funcd.render(template));
      });
    };
  }
