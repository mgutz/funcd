...
(function() {
  var DATA_FUNCD_ASYNC, Funcd, attributeList, defaultAttributes, doctypes, elements, escapeHtml, getTemplateFunction, idSequence, mergeElements, mixinShortTag, mixinTag, nextId, rawContentElements, requireEx, tag, _, _i, _j, _len, _len1, _ref, _ref1, _slice,
    __slice = [].slice,
 ...
 nobr spacer tt',
  ...
  Funcd = (function() {
    ...
    Funcd.prototype.block = function(name, attributes, inner) {
      var exists, options, _ref;
      if ((_ref = this.blocks) == null) {
        this.blocks = {};
      }
    ...
    Funcd.render = function(first, template) {
      var args, args1, builder, options;
